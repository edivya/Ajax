...
//     // get search values
//     // Build request
//     // then update UI with article
// }
// function clearResults () {
//     // Empty articleList
// }
const key = keyHolder.NYT_KEY;
let url = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api_key=qN39vjWWsVWwpgxPsPXsuiCAmlLq35oO";
let queryString = '';
let startYear = 0;
let endYear = 0;
...
const clearForm = () => {
  ...
  endYear = 0;
  numberOfArticles = 10;
  url = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api_key=qN39vjWWsVWwpgxPsPXsuiCAmlLq35oO";
}
